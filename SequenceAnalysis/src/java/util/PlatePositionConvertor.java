...
public class PlatePositionConvertor {
    ...
    public static int convertWellFromA8_12toInt(String well) throws UtilException {
        well.trim();
        int position = -1;
        ...
        if (column > 12) {
            throw new UtilException("Well is not valid.");
        }
    ...
    public static String convertWellFromInttoA8_12(int well) throws UtilException {
        return convertWellFromInttoA8_12(well, 8, 12);
    }

    public static String convertWellFromInttoA8_12(int well, int rownum, int colnum) throws UtilException {
