...
<html:form action="chipGeneGeneAnalysis_2.do" enctype="multipart/form-data">   
    ...
    <tr>
      ...
      <div align="left">
        <table border="1" cellpadding="0" cellspacing="0" width="99%" height="335" bordercolor="#FFFFFF">
            ...
            <tr>
              <td width="200%" height="56" bgcolor="#F2F9FF">
                <font face="Verdana">&nbsp;&nbsp;&nbsp; </font>
                <font color="#000080"><html:radio property="geneInputType" value="Gene Symbol" />
                  <font face="Verdana">Gene Symbol (official gene symbol from <a href="http://www.ncbi.nlm.nih.gov/LocusLink/" target="_blank">
                  NCBI locus link)</a><br>&nbsp;&nbsp;&nbsp; 
                  <html:radio property="geneInputType" value="Locus ID"/>
                  LocusID (<a href="locus_id_from_Access_Number.jsp" target="_blank">how
                  </a>to get LocusID or official gene symbol)
                  </font>
                </font>
              </td>
            </tr>
            ...
            <tr>
              <td width="200%" bgColor="#f2f9ff" height="17"><font color="#0066cc"><br></font>
                ...
                &nbsp;&nbsp; [<a href="ChipGeneInputSample.jsp" target="_blank">sample input</a>]<br>
                ...
                <font face="Verdana" color="#000099">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You can upload your gene list as .txt file.<br>
                  ...
                  [<a href="ChipGeneInputSample.jsp" target="_blank">sample file</a>]</font><p>&nbsp;
              </td>
            </tr>
            <tr>
