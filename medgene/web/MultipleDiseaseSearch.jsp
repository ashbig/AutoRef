        ...
        <table border="1" cellpadding="0" cellspacing="0" width="100%" bordercolor="#99CCFF">
          <tr>
            <td width="100%" bgcolor="#99CCFF"><b><font color="#000099">&nbsp; <img border="0" src="jpg/prompt.gif" width="13" height="13">&nbsp;
              </font><font face="Arial" color="#003399">Please type in the disease
              names, separated by comma </font><font face="Arial" color="#000080">(
              </font><font face="Arial" color="#FF0000">,</font><font face="Arial" color="#000080">
              )</font><font face="Arial" color="#003399">. </font></b></td>
          </tr>
          <tr>
            <td width="100%" bgcolor="#F0F8FF"><b>
          <font color="#000099"><br>
          <br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Disease terms: </font></b>
          <html:text property="searchTerms" size="50" /><br>
              <br>
              <br>
              <br>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b><font face="Arial" color="#003399">
              </font><font color="#003399">The corresponding MeSH term(s) will
              be displayed in the next step.<br>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; The order of the gene list will be
              sorted by the order of the entry.</font></b>
              <p><br>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <html:submit property="submit" value="continue"/><br><br>
              <b><font face="Arial" color="#003399">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <br>
              </font></b>
              </p>
