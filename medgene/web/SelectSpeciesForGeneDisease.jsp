            ...
            <td width="100%" valign="top" align="left" height="222">
              ...
              <div align="center">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="89%">
                  <tr>
                    <td width="100%"><font color="#333300">&nbsp;&nbsp;&nbsp; The disease-gene associations were extracted from
              Medline only for human genes and diseases at MedGene. However, genes from other
              species listed here will be mapped to human genes by using
              HomoloGene at NCBI. Then their relationships to other human diseases
