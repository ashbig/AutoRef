    ...
    <table height="50" cellSpacing="0" cellPadding="0" width="77%" border="0">
      <tbody>
        <tr>
              ...
              <tbody>
                <tr>
                  <td width="100%" bgColor="#99ccff"><b><font color="#000099">&nbsp;
                    ...
                    gene term and select the species.</font></b></td>
                </tr>
                <tr>
                  <td width="100%" bgColor="#f0f8ff"><b><font color="#000099"><br>
                    ...
                    corresponding gene symbol(s) will be displayed in the next
                    step.</font></b></p>
                    <p><br>
          ...
          <td vAlign="top" align="right" width="25%" height="195">
          </td>
        </tr>
        <tr>
...
<div align="center">
  <center>
  <table cellPadding="2" width="75%" border="0" bordercolor="#336699">
    <tr>
      ...
      <td width="89%"><font color="#003366"> The gene-gene associations
        were extracted from Medline only for human genes at MedGene. However, genes from other species listed here will be mapped to
        human genes by using HomoloGene at NCBI. Then their relationship to other human genes can be retrieved and the
