  ...
  <table border="1" cellpadding="0" cellspacing="0" width="96%" height="341" bordercolor="#FFFFFF">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="82%">
          <tr>
            ...
            <td width="96%"><b><font color="#000080" face="Tahoma">Following are
              the correspondng gene symbol(s). </font></b></td>
          </tr>
        </table>
      </td>
    </tr>
      ...
      <td width="200%" height="28">
        <table border="0" cellpadding="0" cellspacing="0" width="90%">
          <tr>
            <td width="4%"><img border="0" src="jpg/prompt.gif" width="13" height="13"></td>
            <td width="96%">
            <b><font face="Verdana" color="#000080">Please choose the number of diseases for your list:</font> </b>
            </td>
          </tr>
        </table>
      </td>
    ...
    <tr>
      <td width="200%" height="67" bgcolor="#D2E9FF">
        ...
        <font color="#0033CC" face="Times New Roman">For performance issue, we only display limited diseases here.&nbsp;<br>
...
<td width="20%" valign="bottom" align="left" height="166">
        &nbsp;&nbsp;&nbsp;<img border="0" src="jpg/human_disease.jpg">
</td>
</tr>
</table>
  </center>
