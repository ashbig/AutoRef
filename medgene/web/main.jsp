  ...
  <table border="0" width="790" height="121" cellpadding="0">
    <tr>
      ...
      <td width="238" height="1" valign="top" align="right">
        &nbsp;
        <p>
        <img border="0" src="jpg/logout.gif" width="50" height="17">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
      </td>
    </tr>
    <tr>
      <td width="238" height="1" valign="bottom" align="right">
        &nbsp;<img border="0" src="jpg/bar_2.gif" width="187" height="24">
      </td>
    </tr>
    <tr>
      <td width="784" colspan="2" height="32" valign="top" align="left">
        <p> <map name="FPMap0">
        <area href="http://www.neu.edu" shape="rect" coords="22, 5, 76, 22">
        <area href="http://www.neu.edu" shape="rect" coords="83, 6, 171, 23">
        <area href="http://www.neu.edu" shape="rect" coords="179, 3, 273, 23">
        <area href="http://www.neu.edu" shape="rect" coords="280, 2, 363, 23"></map><img border="0" src="./jpg/bar_11.jpg" width="454" height="24" usemap="#FPMap0"><a href="http://www.hms.harvard.edu"><img border="0" src="./jpg/bar_13.jpg" width="315" height="24"></a></p>
      </td>
    </tr>
    <tr>
        ...
        <table border="0" width="98%" cellspacing="0" cellpadding="0" height="1">
          ...
          <tr>
            ...
            <td width="100%" height="29" bgcolor="#DCE8FC"><font color="#000080">&nbsp;              
                <html:radio property="geneDiseaseSelect" value="chipGeneDisease"/>  Categorize 
            ...
            <td width="100%" height="27" bgcolor="#DCE8FC"><font color="#000080">&nbsp;
                <html:radio property="geneDiseaseSelect" value="chipGeneGene"/> Categorize 
