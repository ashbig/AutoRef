  ...
  <table border="0" width="90%" height="518" cellpadding="0">
    ...
    <tr>
      <td width="100%" colspan="2" height="40" valign="top" align="left">
        ...
        <area href="mailto:hip_informatics@hms.harvard.edu" shape="rect" coords="280, 2, 363, 23"></map><img border="0" src="./jpg/bar_11.jpg" width="454" height="24" usemap="#FPMap0"><img border="0" src="./jpg/bar_12.jpg" width="90" height="24"><a href="http://www.hms.harvard.edu"><img border="0" src="./jpg/bar_13.jpg" width="315" height="24"></a></p>
      </td>
    </tr>
    <tr>
