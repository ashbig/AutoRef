...
public class FullSeqSpec extends Spec
{
    ...
    public boolean isIgnorByType(int type)
    {
     ...
     public int getDiscrepancyNumberByType(int quality, int changetype,int mode) throws BecDatabaseException 
     {
         ...
         switch (changetype)
         {
             ...
             case Mutation.MACRO_SPECTYPE_MISSENSE:
             {
                 ...
                 {
                      if ( mode == MODE_PASS)
                        return  this.getParameterByNameInt("FS_MISS_PASS_H");
                     else if( mode == MODE_FAIL)
                        return  this.getParameterByNameInt("FS_MISS_FAIL_H");
                 }
                 else 
                 {
                       if ( mode == MODE_PASS)
                        return  this.getParameterByNameInt("FS_MISS_PASS_L");
                     else if( mode == MODE_FAIL)
                        return  this.getParameterByNameInt("FS_MISS_FAIL_L");
                 }
             }
         ...
         {
             System.out.println(e.getMessage() +"getNumber()  quality "+ quality+" change type "+ changetype);
         return CUT_OFF_VALUE_NOT_FOUND;
         }
     }
      ...
      public boolean isIgnorPolymorphismByType( int changetype) throws BecDatabaseException 
     {
         switch (changetype)
         {
             ...
             case Mutation.MACRO_SPECTYPE_MISSENSE:
                 {
                 if  (this.getParameterByName("FS_MISS_POLM")== null)
                     return false;
                 else
                     return true;
             }
     ...
     protected void cleanup_parameters()
     {
         try 
        {
                ...
                {
                     m_params.remove("FS_C_PASS_H");
                     m_params.remove("FS_C_PASS_L");
                     m_params.remove("FS_C_FAIL_H");
                     m_params.remove("FS_C_FAIL_L");
                     m_params.remove("FS_C_POLM");
                    m_params.remove("FS_NC_PASS_H");
                    m_params.remove("FS_NC_PASS_L");
                    m_params.remove("FS_NC_FAIL_H");
                    m_params.remove("FS_NC_FAIL_L" );
                    m_params.remove("FS_NC_POLM" );

                }
                else
                { 
                    m_params.remove("FS_MISS_PASS_H");
                    m_params.remove("FS_MISS_PASS_L");
                    m_params.remove("FS_MISS_FAIL_H");
                    m_params.remove("FS_MISS_FAIL_L");
                    m_params.remove("FS_MISS_POLM");
                }
 ...
 sf.append(   this.getParameterByNameInt("FS_S_FAIL_H")+"\t"  +  this.getParameterByNameInt("FS_S_FAIL_L")+ param_separator);
 
 if ( this.getParameterByName("FS_C_PASS_H") != null )
 {
 sf.append("Conservative substitution"  +Constants.TAB_DELIMETER );
 sf.append(this.getParameterByNameInt("FS_C_PASS_H")+Constants.TAB_DELIMETER  + this.getParameterByNameInt("FS_C_PASS_L")+Constants.TAB_DELIMETER );
 sf.append( this.getParameterByNameInt("FS_C_FAIL_H")+Constants.TAB_DELIMETER  +  this.getParameterByNameInt("FS_C_FAIL_L") + param_separator);
 
 sf.append("Nonconservative substitution"      +Constants.TAB_DELIMETER);
 sf.append(this.getParameterByNameInt("FS_NC_PASS_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt("FS_NC_PASS_L")+Constants.TAB_DELIMETER );
 sf.append( this.getParameterByNameInt("FS_NC_FAIL_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt("FS_NC_FAIL_L")+ param_separator);
 }
  if ( this.getParameterByName("FS_MISS_PASS_H") != null )
 {
 sf.append("Missense substitution"  +Constants.TAB_DELIMETER );
 sf.append(this.getParameterByNameInt("FS_MISS_PASS_H")+Constants.TAB_DELIMETER  + this.getParameterByNameInt("FS_MISS_PASS_L")+Constants.TAB_DELIMETER );
 sf.append( this.getParameterByNameInt("FS_MISS_FAIL_H")+Constants.TAB_DELIMETER  +  this.getParameterByNameInt("FS_MISS_FAIL_L") + param_separator);
  }
 
 sf.append("Frameshift"    +Constants.TAB_DELIMETER );  
 sf.append(this.getParameterByNameInt("FS_FR_PASS_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt("FS_FR_PASS_L")+Constants.TAB_DELIMETER );
 sf.append( this.getParameterByNameInt("FS_FR_FAIL_H")+Constants.TAB_DELIMETER  + this.getParameterByNameInt("FS_FR_FAIL_L")+ param_separator);
 
 sf.append("Inframe deletion" +Constants.TAB_DELIMETER  );  
 sf.append( this.getParameterByNameInt("FS_IDEL_PASS_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt("FS_IDEL_PASS_L")+Constants.TAB_DELIMETER );
 sf.append( this.getParameterByNameInt("FS_IDEL_FAIL_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt("FS_IDEL_FAIL_L")+ param_separator);
 
 sf.append("Inframe insertion"   +Constants.TAB_DELIMETER  );     
 sf.append(this.getParameterByNameInt("FS_IINS_PASS_H")+Constants.TAB_DELIMETER  +  this.getParameterByNameInt("FS_IINS_PASS_L")+Constants.TAB_DELIMETER );
 sf.append( this.getParameterByNameInt("FS_IINS_FAIL_H")+Constants.TAB_DELIMETER  +  this.getParameterByNameInt("FS_IINS_FAIL_L")+ param_separator);
 
 sf.append("Truncation"+Constants.TAB_DELIMETER  );       
 sf.append(this.getParameterByNameInt("FS_TRANC_PASS_H")+Constants.TAB_DELIMETER  + this.getParameterByNameInt("FS_TRANC_PASS_L")+Constants.TAB_DELIMETER );
 sf.append( this.getParameterByNameInt("FS_TRANC_FAIL_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt("FS_TRANC_FAIL_L")+ param_separator);
 
 sf.append("No translation (e.g., no ATG)"  +Constants.TAB_DELIMETER  );  
 sf.append( this.getParameterByNameInt("FS_NOTRANSLATION_PASS_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt("FS_NOTRANSLATION_PASS_L")+Constants.TAB_DELIMETER );
 sf.append( this.getParameterByNameInt("FS_NOTRANSLATION_FAIL_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt("FS_NOTRANSLATION_FAIL_L")+ param_separator);
 
 sf.append("Post-elongation(e.g., no stop codon)"+Constants.TAB_DELIMETER  );             
 sf.append(  this.getParameterByNameInt("FS_PELONG_PASS_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt("FS_PELONG_PASS_L")+Constants.TAB_DELIMETER );
 sf.append(  this.getParameterByNameInt("FS_PELONG_FAIL_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt("FS_PELONG_FAIL_L")+ param_separator);
 ...
 sf.append(this.getParameterByNameInt("FS_5S_PASS_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt("FS_5S_PASS_L")+Constants.TAB_DELIMETER );
 sf.append( this.getParameterByNameInt("FS_5S_FAIL_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt("FS_5S_FAIL_L")+ param_separator);
 
 sf.append("5' deletion/insertion"+Constants.TAB_DELIMETER  );     
 sf.append( this.getParameterByNameInt("FS_5DI_PASS_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt("FS_5DI_PASS_L")+Constants.TAB_DELIMETER );
 sf.append( this.getParameterByNameInt("FS_5DI_FAIL_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt("FS_5DI_FAIL_L")+ param_separator);
 
 sf.append("3' substitution"+Constants.TAB_DELIMETER  );        
 sf.append(this.getParameterByNameInt("FS_3S_PASS_H")+Constants.TAB_DELIMETER +this.getParameterByNameInt("FS_3S_PASS_L")+Constants.TAB_DELIMETER );
 sf.append( this.getParameterByNameInt("FS_3S_FAIL_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt("FS_3S_FAIL_L")+ param_separator);
 
 sf.append("3' deletion/insertion"+Constants.TAB_DELIMETER  );          
  
 sf.append( this.getParameterByNameInt("FS_3DI_PASS_H")+Constants.TAB_DELIMETER+ this.getParameterByNameInt("FS_3DI_PASS_L")+Constants.TAB_DELIMETER );
 sf.append( this.getParameterByNameInt("FS_3DI_FAIL_H")+Constants.TAB_DELIMETER+this.getParameterByNameInt("FS_3DI_FAIL_L")+ param_separator);
 
 sf.append("Maximum acceptable number of discrepancies introduced by ambiquous bases"+ param_separator);

   
 sf.append("Base Confidence:"+Constants.TAB_DELIMETER+"High"+Constants.TAB_DELIMETER+"Low"+Constants.TAB_DELIMETER+"High"+Constants.TAB_DELIMETER+"Low" + param_separator);
sf.append("Start codon substitution"+Constants.TAB_DELIMETER  );  
 sf.append( this.getParameterByNameInt( "FS_NSTART_PASS_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt( "FS_NSTART_PASS_L")+Constants.TAB_DELIMETER  +this.getParameterByNameInt( "FS_NSTART_FAIL_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt(  "FS_NSTART_FAIL_L")+ param_separator); 
sf.append("Stop codon substitution"+Constants.TAB_DELIMETER  );     
 sf.append( this.getParameterByNameInt( "FS_NSTOP_PASS_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt( "FS_NSTOP_PASS_L")+Constants.TAB_DELIMETER  +this.getParameterByNameInt( "FS_NSTOP_FAIL_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt( "FS_NSTOP_FAIL_L" )+ param_separator);
sf.append("Substituttion cds"+Constants.TAB_DELIMETER  );     
 sf.append( this.getParameterByNameInt( "FS_NCDS_PASS_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt( "FS_NCDS_PASS_L")+Constants.TAB_DELIMETER  +this.getParameterByNameInt( "FS_NCDS_FAIL_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt( "FS_NCDS_FAIL_L" )+ param_separator);
sf.append("Frameshift Insertion"+Constants.TAB_DELIMETER  );     
 sf.append( this.getParameterByNameInt( "FS_NFRAME_PASS_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt( "FS_NFRAME_PASS_L")+Constants.TAB_DELIMETER  +this.getParameterByNameInt( "FS_NFRAME_FAIL_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt( "FS_NFRAME_FAIL_L" )+ param_separator);
sf.append("Inframe Insertion"+Constants.TAB_DELIMETER  );     
 sf.append( this.getParameterByNameInt( "FS_NINFRAME_PASS_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt( "FS_NINFRAME_PASS_L")+Constants.TAB_DELIMETER  +this.getParameterByNameInt(  "FS_NINFRAME_FAIL_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt( "FS_NINFRAME_FAIL_L")+ param_separator); 
sf.append("Substitution 5'"+Constants.TAB_DELIMETER  );     
 sf.append( this.getParameterByNameInt(  "FS_N5SUB_PASS_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt( "FS_N5SUB_PASS_L")+Constants.TAB_DELIMETER  +this.getParameterByNameInt( "FS_N5SUB_FAIL_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt( "FS_N5SUB_FAIL_L")+ param_separator);
sf.append("Insertion 5' linker"+Constants.TAB_DELIMETER  );     
 sf.append( this.getParameterByNameInt(  "FS_N5INS_PASS_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt(  "FS_N5INS_PASS_L")+Constants.TAB_DELIMETER  +this.getParameterByNameInt(  "FS_N5INS_FAIL_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt(  "FS_N5INS_FAIL_L"  )+ param_separator);
sf.append("Substitution 3'"+Constants.TAB_DELIMETER  );     
 sf.append( this.getParameterByNameInt(  "FS_N3SUB_PASS_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt(  "FS_N3SUB_PASS_L")+Constants.TAB_DELIMETER  +this.getParameterByNameInt(  "FS_N3SUB_FAIL_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt(  "FS_N3SUB_FAIL_L"  )+ param_separator);
sf.append("Insertion 3' linker "+Constants.TAB_DELIMETER  );     
 sf.append( this.getParameterByNameInt( "FS_N3INS_PASS_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt(  "FS_N3INS_PASS_L")+Constants.TAB_DELIMETER  +this.getParameterByNameInt(  "FS_N3INS_FAIL_H")+Constants.TAB_DELIMETER  +this.getParameterByNameInt(  "FS_N3INS_FAIL_L")+ param_separator);
  ...
  ArrayList specs =null;
        try {
            ...
            c = t.requestConnection();
             ...
             System.out.println( spec.print_parameter_definitions("\n"));
        /*     
