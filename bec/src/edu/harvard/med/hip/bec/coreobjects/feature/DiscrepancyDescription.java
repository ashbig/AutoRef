    ...
    private static DiscrepancyDescription getMaxQualityDiscrepancy(DiscrepancyDescription description_one, DiscrepancyDescription description_two)
       ...
       private static boolean isMaxDiscrepancy(Mutation mut_one, Mutation mut_two)
      {
       ...
       public  String                 writeInXMLFormat()
       {
             switch( this.getDiscrepancyDefintionType())
             {
                ...
                case DiscrepancyDescription.TYPE_NOT_AA_LINKER : 
                        return writeNonRNADiscrepancyInXMLFormat(this.m_linker, this.m_linker.getNumber()+1);
                case DiscrepancyDescription.TYPE_NOT_AA_AMBIQUOUS:
                case DiscrepancyDescription.TYPE_NOT_AA_REFSEQUENCE_AMB :
                    return writeNonRNADiscrepancyInXMLFormat(this.m_rna_without_aa,  this.m_rna_without_aa.getNumber()+1);
                 default: return "";
             }
       }
       ...
       private String               writeNonRNADiscrepancyInXMLFormat(Mutation discrepancy,
                     int discrepancy_number)
       {
StringBuffer discrepancy_in_xml_format = new StringBuffer();  
discrepancy_in_xml_format.append( Constants.LINE_SEPARATOR+"\t <discrepancy number='"+ discrepancy_number+"' description=''>");
discrepancy_in_xml_format.append( Constants.LINE_SEPARATOR+" <nucleotide_definition changetype='" + discrepancy.getChangeType());
discrepancy_in_xml_format.append("' quality='"+ discrepancy.getQuality() );
...
return discrepancy_in_xml_format.toString();
       ...
       {
            StringBuffer discrepancy_in_xml_format = new StringBuffer();  
            discrepancy_in_xml_format.append(" \t<discrepancy number='"+ (m_aa.getNumber()+1)+"' description=''>");
           ...
           discrepancy_in_xml_format.append(  writeAADiscrepancyInXMLFormat( m_aa));
            discrepancy_in_xml_format.append(" </discrepancy>" + Constants.LINE_SEPARATOR);
            return discrepancy_in_xml_format.toString();
       }
        
               private String               writeAADiscrepancyInXMLFormat(Mutation discrepancy )
       {
StringBuffer discrepancy_in_xml_format = new StringBuffer();  
discrepancy_in_xml_format.append( Constants.LINE_SEPARATOR+"\t\t <aa_definition changetype='" + discrepancy.getChangeType());
discrepancy_in_xml_format.append("' quality='"+ discrepancy.getQuality() );
discrepancy_in_xml_format.append("' ref_position='" + discrepancy.getPosition() );
discrepancy_in_xml_format.append("' exp_position='"+ discrepancy .getExpPosition() ); 
discrepancy_in_xml_format.append("' length='"+ discrepancy.getLength() );
...
return discrepancy_in_xml_format.toString();
        ...
        private String               writeRNADiscrepancyInXMLFormat(RNAMutation discrepancy)
       {
            ...
            discrepancy_in_xml_format.append("' chage_ori='" + discrepancy.getSubjectStr() ); 
            discrepancy_in_xml_format.append("' change_mut='" + discrepancy.getQueryStr() );
            discrepancy_in_xml_format.append("' p_flag='" + discrepancy.getPolymorphismFlag());
            discrepancy_in_xml_format.append("' p_id='");
            if ( discrepancy.getPolymorphismId() != null ) discrepancy_in_xml_format.append( discrepancy.getPolymorphismId());
