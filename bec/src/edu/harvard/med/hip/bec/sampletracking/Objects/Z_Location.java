/**
 * $Id: Z_Location.java,v 1.1 2003-04-16 17:49:49 Elena Exp $
 *
 * File     	: Location.java
 * Date     	: 04262001
 * Author	: Dongmei Zuo
...
public class Z_Location
{
     ...
     */
    public Z_Location(int id, String type, String description)
    {
        this.id = id;
        this.type = type;
     ...
     */
    public Z_Location(int id) throws BecDatabaseException, BecUtilException
    {
        this.id = id;
        restore();
    }
     ...
     */
    public Z_Location(String locationName) throws BecDatabaseException, BecUtilException
    {
    ...
    public static ArrayList getLocations() throws BecDatabaseException
    {
        ...
        try
        {
            while (rs.next())
            {
                ...
                Z_Location l = new Z_Location(id, type, description);
                locations.add(l);
            }
