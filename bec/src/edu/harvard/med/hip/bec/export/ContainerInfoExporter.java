...
//import edu.harvard.med.hip.bec.core.*;
import edu.harvard.med.hip.bec.database.*;
import edu.harvard.med.hip.bec.util.*;
//import edu.harvard.med.hip.bec.process.Process;
//import edu.harvard.med.hip.bec.process.Result;
//import edu.harvard.med.hip.bec.process.*;
    ...
    public boolean doExport(int id, int executionid, PrintWriter out)
    {
         ...
         /*try {
            ...
            for(int i=0; i<samples.size(); i++) {
                ...
                RefSequence sequence = sample.getRefSequence();
                if(sequenceid)
