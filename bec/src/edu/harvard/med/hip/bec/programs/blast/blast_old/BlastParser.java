...
package edu.harvard.med.hip.bec.programs.blast.blast_old;
...
public class BlastParser implements BlastParserConstants
{
    ...
    public  Hashtable getQuryInfo()
    { return qryInfoHT;     }
    
    /** Return query sequence ID as a String object */
    public  String getQuerySeqID()
    { return (String)qryInfoHT.get("qry_name"); }
    
    /** Return query sequence length as a String object */
    public  String getQuerySeqLength()
    { return (String)qryInfoHT.get("qry_length"); }
    ...
    public  String getGapPenalties()
    { return (String)srchInfoHT.get("gaps"); }
    
    /** Return blast database path */
    public  String getDBPath()
    { return (String)srchInfoHT.get("dbpath"); }
    
    /** Return the number of sequence in current blast database */
    public  String getDBSize()
    { return (String)srchInfoHT.get("dbsize"); }
    
    /** Return the total number of residues in current blast database */
    public  String getDBLetters()
    { return (String)srchInfoHT.get("dbletters"); }
    
    /** To access database information which returns a Hashtable object */
    public  Hashtable getDBInfo()
    { return dbInfoHT;      }
     ...
     */
    public  ArrayList getHomologList()
    { return homologList;   }
    ...
    public class HomologItem
    {
        ...
        { subID  = id;  }
        public void setSubLen(int len)
        { subLen = len; }
        public void addAlignItem(Alignment align)
        { alignList.add(align); }
    ...
    public class Alignment
    {
        ...
        { return alignInfo.getProperty("score");    }
        
        /** Return E value of a local alignment */
        public String getEvalue()
        { return alignInfo.getProperty("evalue");   }
        
        /** Return identities of residues of a local alignment */
        public String getIdentity()
        { return alignInfo.getProperty("identity"); }
        
        /** Return sum of gaps of both aligned strands */
        public String getGap()
        { return alignInfo.getProperty("gap");      }
        /** Return relative direction of aligned two strands */
        public String getStrand()
        { return alignInfo.getProperty("strand");   }
        
        private void setQryStart(int start)
        { qryStart = start;   }
        private void setQryEnd(int end)
        { qryEnd   = end;     }
        private void setQrySeq(String seq)
        { qrySeq.append(seq); }
        
        private void setSbjStart(int start)
        { sbjStart = start;   }
        private void setSbjEnd(int end)
        { sbjEnd   = end;     }
        private void setSbjSeq(String seq)
        { sbjSeq.append(seq); }
        ...
        { return qrySeq.toString();   }
        
        public int getSbjStart()
        { return sbjStart; }
        public int getSbjEnd()
        { return sbjEnd;   }
        public String getSbjSeq()
        { return sbjSeq.toString();   }
    ...
    public  void displayParsed()
    {
        ...
        {  // loop through all homologs
            ...
            { // each homolog has one or more Alignment
                count = j + 1;
    ...
    public static void main(String args[])
    {
            ...
            BlastParser parser = new BlastParser("C:\\GenBankMonth\\blast.out");
            try
            {
                parser.parseBlast();
