...
PROCESS_UPLOAD_PLATES ,    //upload plates
PROCESS_SELECT_VECTOR_FOR_END_READS ,  //run sequencing for end reads
PROCESS_SELECT_PLATES_FOR_END_READS ,   
PROCESS_RUN_END_READS ,   //run sequencing for end reads
PROCESS_RUN_END_READS_WRAPPER ,   //run end reads wrapper
PROCESS_RUN_ASSEMBLER_FOR_END_READS ,   //run assembly wrapper
PROCESS_SELECT_PLATES_TO_CHECK_READS_AVAILABILITY ,  
PROCESS_CHECK_READS_AVAILABILITY ,  //check reads
PROCESS_RUN_ISOLATE_RUNKER ,   //run isolate runker
PROCESS_ADD_NEW_INTERNAL_PRIMER ,    // add new internal primer
PROCESS_VIEW_INTERNAL_PRIMERS ,   //view internal primers
PROCESS_APPROVE_INTERNAL_PRIMERS ,   //approve internal primers
PROCESS_RUN_PRIMER ,   //run primer 
PROCESS_RUN_ASSEMBLER_FOR_ALL_READS ,   //run assembly wrapper
PROCESS_RUNPOLYMORPHISM_FINDER,    //run polymorphism finder
PROCESS_RUN_DISCREPANCY_FINDER,   //run discrepancy finder
PROCESS_RUN_DECISION_TOOL ,   //run decision tool
PROCESS_RUN_DISCREPANCY_FINDER_STANDALONE ,   //run decision tool
PROCESS_SUBMIT_ASSEMBLED_SEQUENCE ,   
PROCESS_CREATE_REPORT ,   
PROCESS_SHOW_CLONE_HISTORY ,   
PROCESS_ORDER_INTERNAL_PRIMERS ,   
PROCESS_PROCESS_OLIGO_PLATE ,   
PROCESS_VIEW_OLIGO_PLATE ,   
PROCESS_CREATE_FILE_FOR_TRACEFILES_TRANSFER ,   
PROCESS_INITIATE_TRACEFILES_TRANSFER ,   
PROCESS_NOMATCH_REPORT  ,   
PROCESS_CREATE_RENAMING_FILE_FOR_TRACEFILES_TRANSFER ,   
PROCESS_FIND_GAPS  ,   
PROCESS_FIND_LQR_FOR_CLONE_SEQUENCE  ,   
PROCESS_CREATE_ORDER_LIST_FOR_ER_RESEQUENCING  ,   
PROCESS_CREATE_ORDER_LIST_FOR_INTERNAL_RESEQUENCING  ,   
PROCESS_DELETE_PLATE ,   //
PROCESS_DELETE_CLONE_READS ,   //
PROCESS_DELETE_CLONE_FORWARD_READ ,   //
PROCESS_DELETE_CLONE_REVERSE_READ ,   //
PROCESS_DELETE_CLONE_SEQUENCE ,   //
PROCESS_GET_TRACE_FILE_NAMES ,   
PROCESS_DELETE_TRACE_FILES ,   
PROCESS_MOVE_TRACE_FILES ,   
PROCESS_VIEW_OLIGO_ORDER_BY_CLONEID ,   
PROCESS_RUN_DECISION_TOOL_NEW  ,   
PROCESS_CREATE_REPORT_TRACEFILES_QUALITY  ,   

//  

//settings database
PROCESS_ADD_NEW_LINKER  ,   
PROCESS_ADD_NEW_VECTOR  ,   
PROCESS_ADD_NAME_TYPE  ,   
PROCESS_ADD_SPECIES_DEFINITION  ,   
PROCESS_ADD_PROJECT_DEFINITION  ,   

PROCESS_VIEW_ALL_NAME_TYPE  ,   
PROCESS_VIEW_ALL_SPECIES_DEFINITION  ,   
PROCESS_VIEW_ALL_PROJECT_DEFINITION  ,   
PROCESS_ADD_NEW_CONNECTION_VECTOR_LINKER  ,   
PROCESS_ADD_NEW_COMMON_PRIMER  ,   
PROCESS_ADD_NEW_CLONINGSTRATEGY   ,   
PROCESS_ADD_TRACE_FILE_NAME_FORMAT       ,    

// outside submission
PROCESS_SUBMIT_REFERENCE_SEQUENCES  ,   
PROCESS_SUBMIT_CLONE_COLLECTION  ,   
PROCESS_SUBMIT_CLONE_SEQUENCES  ,    

PROCESS_SET_CLONE_FINAL_STATUS  ,    
PROCESS_REANALYZE_CLONE_SEQUENCE  ,    
PROCESS_VERIFY_TRACE_FILE_FORMAT ,   
PROCESS_DELETE_TRACE_FILE_FORMAT ,   
PROCESS_CLEANUP_INTERMIDIATE_FILES_FROM_HARD_DRIVE ,   
PROCESS_SUBMIT_EREADS_AS_INTERNALS ,   
PROCESS_SELECT_SEQUENCING_PRIMERS_FOR_END_READS ,    //run sequencing for end reads
PROCESS_SELECT_PLATES_FOR_END_READS_NEW_VERSION ,      
PROCESS_ADD_NEW_LINKER_FROM_FILE  ,    
PROCESS_ADD_NAME_TYPE_FROM_FILE  ,   
PROCESS_ADD_SPECIES_DEFINITION_FROM_FILE ,    
PROCESS_ADD_NEW_CLONINGSTRATEGY_FROM_FILE,   
PROCESS_ADD_NEW_VECTOR_FROM_FLAT_FILES}
     /**/
