...
public class trimming_java_script {
    ...
    public static void main(String arg[])
    {
        ...
        {
            directory_name= "/cygdrive/f/trace_files_root/clone_samples/36768/122227";//\\phd_dir\\6142_E05_3277_4426_F5.ab1.phd.1";
             directory_name = convertUnixFileNameIntoWindowsBasedOnOneLetterApproach( directory_name);
        }
   ...
   public static void saveAsFile( String new_file_name, String old_file_name) throws Exception
   {
   ...
   public static String convertUnixFileNameIntoWindows(String filename)
    {
   ...
   public static String convertUnixFileNameIntoWindowsBasedOnOneLetterApproach(String filename)
    {
        //                /c/bio/plate_analysis/clone_samples/3277/4426
        String res = null;
