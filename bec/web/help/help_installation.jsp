...
<table  class=menu align="center">
  <tbody>
    ...
    <tr> 
      <td><h2><font color="#0099CC">1. Third-party Program Installations </font></h2>
        ...
        <ul>
          ...
          <li> Install <a href="ftp://ftp.ncbi.nih.gov/blast/"  target="_blank">NCBI 
            ...
            if you are not going to use the 'Mismatched clones' feature.</li>
        ...
        <ul>
          <li> Place ACE package distribution '.warfile from Harvard Institute 
          ...
          <li>Copy Trimming_java_script.class and Trimming_java_script$ScoredElement.class 
            provided by HIP to ACE server hard drive. These classes are used for 
          ...
          <li>Edit <a href="help_PhredPhrap.html"  target="_blank"> Phred Parameter 
            ...
            according to installation instructions for PhredPhrap package</li>
          <li>Set-up scheduled tasks / cron jobs to: (a) clean up TEMPORARY_FILES_FILE_PATH 
            and NEEDLE_OUTPUT_TMP_PATH directories (<a href="help_ACEConfigurationFile.html"  target="_blank">ACE 
            configuration file</a>); (b) clean up all *.in files from NEEDLE_OUTPUT_PATH 
            directory; (c) Optional: rebuild user blastable databases if applicable</li>
        </ul>
