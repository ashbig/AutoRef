...
<table border="0" cellpadding="0" cellspacing="0" width="84%" align=center>
  <tr> 
    <td colspan =2><div align="right"><b> <a href="<%= edu.harvard.med.hip.utility.ApplicationHostDeclaration.JSP_REDIRECTION %>Seq_GetSpec.do?forwardName=<%=Spec.TRIM_SLIDING_WINDOW_SPEC_INT * Spec.SPEC_SHOW_USER_ONLY_SPECS %> "> 
        View Mine </a>&nbsp;&nbsp;<a href="<%= edu.harvard.med.hip.utility.ApplicationHostDeclaration.JSP_REDIRECTION %>Seq_GetSpec.do?forwardName=<%=Spec.TRIM_SLIDING_WINDOW_SPEC_INT%>"> 
        View All </a></b> </div>
      <p> 
      <p> 
 ...
 <tr> 
    ...
    id="SW_Q_CUTT_OFF"
    value="<%= SlidingWindowTrimmingSpec.QUALITY_CUTT_OFF %>" width="50" ></td>
  </tr>
...
<tr> 
    ...
    value="<%= SlidingWindowTrimmingSpec.QUALITY_NUMBER_LOW_QUALITY_BASES %>" width="50" ></td>
  </tr>
<tr> 
    ...
    value="<%= SlidingWindowTrimmingSpec.QUALITY_NUMBER_LOW_QUALITY_BASES_CONQ %>" width="50" ></td>
  </tr>
...
<tr> 
    ...
    id="SW_A_WINDOW_SIZE"     value="<%= SlidingWindowTrimmingSpec.AMBIQUATY_WINDOW_SIZE %>" width="50" ></td>
  </tr>
<tr> 
    ...
    id="SW_A_NUMBER_BASES"     value="<%= SlidingWindowTrimmingSpec.AMBIQUATY_NUMBER_BASES %>" width="50" ></td>
  </tr>
<tr> 
