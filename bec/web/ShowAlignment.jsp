...
<table border="0" cellpadding="0" cellspacing="0" width="74%" align=center>
 ...
 <TR> 
    ...
    <td>
        <a href="#" onCLick="window.open('<%=edu.harvard.med.hip.bec.util.BecProperties.getInstance().getProperty("JSP_REDIRECTION") %>Seq_GetItem.do?forwardName=<%=Constants.REFSEQUENCE_DEFINITION_INT%>&amp;ID=<%= request.getAttribute("refsequence_id")%>');" > 
