  ...
  <tr><td colspan="2">
    ...
    <tr> 
        ...
        <tr> 
          ...
          <td width="16%" bgcolor="#e4e9f8"><div align="center"> <input name="ER_NSTART_PASS_H" type="input" id="ER_NSTART_PASS_H" value="0" size="10" ></div></td>
          <td width="14%"bgcolor="#e4e9f8"><div align="center"> <input name="ER_NSTART_PASS_L" type="input" id="ER_NSTART_PASS_L" value="0" size="10" > 
            </div></td>
        </tr>
        <tr> 
          <td bgColor="#b8c6ed"><b><strong><font color="#000080">Stop codon substitution</font></strong></b></td>
          <td bgColor="#b8c6ed"><div align="center">       
              <input name="ER_NSTOP_PASS_H" type="input" id="ER_NSTOP_PASS_H" value="0" size="10" >
             </div></td>
          <td bgColor="#b8c6ed"><div align="center">  
              <input name="ER_NSTOP_PASS_L" type="input" id="ER_NSTOP_PASS_L" value="0" size="10" >
             </div></td>
        </tr>
        <tr> 
          ...
          <td bgColor="#e4e9f8"><div align="center"> 
              <input name="ER_NCDS_PASS_H" type="input" id="ER_NCDS_PASS_H" value="0" size="10" >
            </div></td>
          <td bgColor="#e4e9f8"><div align="center"> 
              <input name="ER_NCDS_PASS_L" type="input" id="ER_NCDS_PASS_L" value="0" size="10" >
            </div></td>
        </tr>
        <tr> 
          <td bgColor="#b8c6ed"><strong><font color="#000080">Frameshift Insertion</font></strong></td>
          <td bgColor="#b8c6ed"><div align="center"> 
              <input name="ER_NFRAME_PASS_H" type="input" id="ER_NFRAME_PASS_H" value="0" size="10" >
            </div></td>
          <td bgColor="#b8c6ed"><div align="center"> 
              <input name="ER_NFRAME_PASS_L" type="input" id="ER_NFRAME_PASS_L" value="0" size="10" >
            </div></td>
        </tr>
        <tr> 
          <td bgColor="#e4e9f8"><strong><font color="#000080">Inframe Insertion</font></strong></td>
          <td bgColor="#e4e9f8"><div align="center"> 
              <input name="ER_NINFRAME_PASS_H" type="input" id="ER_NINFRAME_PASS_H" value="0" size="10" >
            </div></td>
          <td bgColor="#e4e9f8"><div align="center"> 
              <input name="ER_NINFRAME_PASS_L" type="input" id="ER_NINFRAME_PASS_L" value="0" size="10" > 
            </div></td>
        </tr>
        <tr> 
          ...
          <td bgColor="#b8c6ed"><div align="center"> 
              <input name="ER_N5SUB_PASS_H" type="input" id="ER_N5SUB_PASS_H" value="0" size="10" >
            </div></td>
          <td bgColor="#b8c6ed"><div align="center"> 
              <input name="ER_N5SUB_PASS_L" type="input" id="ER_N5SUB_PASS_L" value="0" size="10" >
            </div></td>
        </tr>
        <tr> 
          <td bgColor="#e4e9f8"><strong><font color="#000080">Insertion 5' linker 
            region </font></strong></td>
          <td bgColor="#e4e9f8"><div align="center"> 
              <input name="ER_N5INS_PASS_H" type="input" id="ER_N5INS_PASS_H" value="0" size="10" >
            </div></td>
          <td bgColor="#e4e9f8"><div align="center"> 
              <input name="ER_N5INS_PASS_L" type="input" id="ER_N5INS_PASS_L" value="0" size="10" > 
            </div></td>
        </tr>
        <tr> 
          <td bgColor="#b8c6ed"><strong><font color="#000080">Substitution 3' 
            linker region</font></strong></td>
          <td bgColor="#b8c6ed"><div align="center"> 
              <input name="ER_N3SUB_PASS_H" type="input" id="ER_N3SUB_PASS_H" value="0" size="10" > 
            </div></td>
          <td bgColor="#b8c6ed"><div align="center"> 
              <input name="ER_N3SUB_PASS_L" type="input" id="ER_N3SUB_PASS_L" value="0" size="10" > 
            </div></td>
        </tr>
        <tr> 
          <td bgColor="#e4e9f8"><strong><font color="#000080">Insertion 3' linker 
            region </font></strong></td>
          <td bgColor="#e4e9f8"><div align="center"> 
              <input name="ER_N3INS_PASS_H" type="input" id="ER_N3INS_PASS_H" value="0" size="10" > 
            </div></td>
          <td bgColor="#e4e9f8"><div align="center"> 
              <input name="ER_N3INS_PASS_L" type="input" id="ER_N3INS_PASS_L" value="0" size="10" > 
            </div></td>
        </tr>
		</table></div>
		</td>
