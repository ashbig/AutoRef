...
<table border="0" cellpadding="0" cellspacing="0" width="84%" align=center>
  ...
  <tr> 
   ...
   <tr> 
    ...
    <td> <a href="#" onCLick="window.open('<%= edu.harvard.med.hip.bec.util.BecProperties.getInstance().getProperty("JSP_REDIRECTION") %>Seq_GetItem.do?forwardName=<%=Constants.REFSEQUENCE_DEFINITION_INT%>&amp;ID=<%= construct.getRefSeqId()%>','newWndRefseqNt','width=500,height=400,menubar=no,location=no,scrollbars=yes,resizable=yes');return false;" > 
