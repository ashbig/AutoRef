...
function fnShowVectorDetails()
{
   ...
   alert(vectorid);
    var r = "window.open('/BEC/Seq_GetItem.do?forwardName=<%=Constants.VECTOR_DEFINITION_INT%>&amp;ID="+ vectorid +"','vectordetails','width=500,height=400,menubar=no,location=no,scrollbars=yes,resizable=yes')";
