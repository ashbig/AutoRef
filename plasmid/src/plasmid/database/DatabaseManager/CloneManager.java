   ...
   */
    ...
    */
    private boolean getSAMTubes ( String bbtube) throws SQLException, ClassNotFoundException {
		...
		Connection conn = DriverManager.getConnection("jdbc:sqlserver://SAM-20KDX1;instanceName=SQLEXPRESS;integratedSecurity=false;user=sa;password=hst;database=SamManager");
