...
public class OrderProcessManager {
    ...
    public void sendTroubleshootingEmail(int orderid, String email) {
        ...
        String text =
                "Dear PlasmID User,\n\n"
                + "Iwrite in regard to your recent order from the PlasmID Repository. Unfortunately one or more of the clones in your order did not pass our Platinum quality control (QC) test.  To view the results of our QC testing please log into your account, select the appropriate order number, and then select \"View Platinum Results\". We have already streaked the failed construct(s) on agar and selected four isolates for further analysis. Unfortunately none of those isolates passed our quality control testing.\n\n"
