 ...
 * @author  DZuo
 */
public class AuthorNameQueryHandler extends GeneQueryHandler {
    
    /** Creates a new instance of AuthorNameQueryHandler */
    public AuthorNameQueryHandler() {
    }
    
    public AuthorNameQueryHandler(List terms) {
        super(terms);
    }
    ...
    public Set doQuery(List restrictions, List clonetypes, String species, int start, int end) throws Exception {
        ...
        " where upper(authorname) like upper(?))"+
        ...
        return executeQuery(sql, start, end, 1, true);
    }
