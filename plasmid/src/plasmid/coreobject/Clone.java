...
public class Clone implements Serializable {
    ...
    public Clone(int cloneid, String name, String type, String verified,
            String vermethod, String domain, String subdomain, String restriction,
            String comments, int vectorid, String vectorname, String clonemap, String status,
            String specialtreatment, String source, String description, String sender,
            String sdate, String receiver, String rdate) {
        this(cloneid, name, type, verified, vermethod, domain, subdomain, restriction,
                comments, vectorid, vectorname, clonemap, status, specialtreatment, source, description);
        this.sender = sender;
        this.sdate = sdate;
    ...
    public GrowthCondition getRecommendedGrowthCondition() {
        return recommendedGrowthCondition;
    }

    public CloneVector getVector() {
        return vector;
    }
    ...
    public void setVermethod(String s) {
        this.vermethod = s;
    }
    ...
    public void setSubdomain(String s) {
        this.subdomain = s;
    }
    ...
    public void setClonemap(String s) {
        this.clonemap = s;
    }
    ...
    public void setRecommendedGrowthCondition(GrowthCondition g) {
        this.recommendedGrowthCondition = g;
    }

    public void setVector(CloneVector v) {
        this.vector = v;
    }
    ...
    public void setSelections(List l) {
        this.selections = l;
    }

    public List getGrowths() {
        return growths;
    }

    public void setGrowths(List l) {
        this.growths = l;
    }
