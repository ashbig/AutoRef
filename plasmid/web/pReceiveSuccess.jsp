                                                ...
                                                <td>
                                                    <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="blue">
                                                        ...
                                                        <logic:iterate id="Clone" name="CLONES" indexId="CID">
                                                            <tr bgcolor="white">
                                                                <td>&nbsp;<a href="http://plasmid.med.harvard.edu/PLASMID/GetCloneDetail.do?cloneid=<bean:write name="Clone" property="cloneid"/>" target="clonedetail"><bean:write name="Clone" property="name"/></a></td>
                                                                <td>
