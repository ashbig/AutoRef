...
<div class="gridContainer clearfix">
    ...
    <body>
        ...
        <table width="900px" id='content' border="0" align="left" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
            <tr> 
                ...
                <td width="83%" align="left" valign="top">
                    ...
                    <html:form action="SEQ_SearchInvoice.do" focus="invoicenums">
                        <table width="100%" border="0">
                            <tr>
                                <td class="formlabel">Invoice Number (remove 'SEQ_'; separate each invoice by comma [,]):</td>
                            ...
                            <tr> 
                                ...
                                <td colspan="4" class="itemtext"><html:text property="institution1" size="50"/></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
