...
<div align="center"> 
  ...
  <table width="586" border="0"> 
    <tr> 
      <td bgcolor="#F3F3F3" class="mainbodytextlarge"><p><a href="#who"><br>Who We Are</a> <br> 
          <a href="#registration">How to Order Plasmids: PlasmID Registration</a> <br> 
          <a href="#searchorder">How to Order Plasmids: PlasmID Search &amp; Order </a><br> 
      ...
      <td class="mainbodytext"><p><strong class="homepageText2"><a name="who"></a>WHO WE  ARE</strong><br><br> 
        ...
        <p><strong class="homepageText2">HOW TO  ORDER PLASMIDS</strong><br> 
            <span class="mainbodytextlarge"><br> 
                <strong><a name="registration"></a>PlasmID Registration</strong> </span><br> 
                <span class="mainbodytext"><br> 
                <strong>Q. Do I have to  register?</strong> <br> 
                A. You do not have to register  to search the database, download vector and clone maps, or view other  information. However, you do have to register and sign in before placing a  request. Registration is live so you will be able to sign in as soon as you  have completed on-line registration.&nbsp; We recommend signing in before you  start searching for plasmids because not all plasmids are visible before registration and it saves a few steps later if you plan on ordering plasmids.<br><br> 
                <strong>Q.&nbsp;My PI is not on  the registration list.&nbsp; How do I register?</strong> <br> 
                A. You will need to fill out  information for both yourself and the PI during registration.&nbsp;People from  the same lab will be able to find their PI on the list the next time someone  registers.<br><br> 
                <strong>Q.&nbsp;I am the PI in  addition to being the &ldquo;user&rdquo; who will place orders.&nbsp; How do I register?</strong> <br> 
          A. Please enter your information  in both the user and PI fields during registration. <br> 
          <span class="mainbodytextlarge"><br> 
          <strong><a name="searchorder"></a>PlasmID Search & Order</strong> </span><br><br> 
          
          <strong>Q.&nbsp; How do I search for plasmids?</strong><br> 
          There are many ways to search for plasmids  on PlasmID.&nbsp; You can search by specific  terms, such as vector, insert name, CloneID, depositor, TargetDB ID, PDB ID,  protein expression, solubility or purification. <a href="OrderOverview.jsp">Click here</a> for all our search options.<br><br> 
          <strong>Q. I did not find a  plasmid of interest in your collection.&nbsp; Am I searching correctly?</strong> <br> 
          A. The most flexible search tool  at PlasmID is the Advanced Text Search tool. There, you can use gene names and  synonyms, author names, the part or full name of a vector, species name, PDB  ID, TargetDB/PepcDB ID or combinations to search plasmids. It is also helpful  to use &ldquo;official&rdquo; gene names and identifiers as they appear in databases such  as NCBI Entrez Gene or organism-specific databases like SGD or FlyBase. Try  &ldquo;view empty vectors&rdquo; to see a list of vectors that take inserts, act as helper  vectors, etc. You can enter more than one ID in a field at &ldquo;search by gene&rdquo; to  search multiple genes at one time.<br><br> 
          <strong>Q. How do I place a  request for plasmids I identified on PlasmID?</strong> <br> 
          A. Once you identify a plasmid  of interest (in a search results table or on a static list, for example), click  the button at the far right-hand side of the page to add it to your shopping  cart.&nbsp; When you are ready to check out, click the shopping cart icon (top  right of any page) to initiate check-out and follow the steps, being sure to  click the button at the bottom until your request is confirmed. <a href="OrderOverview.jsp">Click  here</a> for more details about how to order. <br><br> 
          <strong>Q. How do I know if my  request went through or when I will receive the plasmid?</strong> <br> 
          A. After you place a request,  our system will send a confirmation email.&nbsp; You can sign in at any time to  view the status of your request.&nbsp; In addition, you will receive an email  when the plasmid is shipped, including FedEx tracking information.&nbsp;  Requests are filled in the order in which they are received.&nbsp; Changes  day-to-day in the volume and size of requests makes it difficult to tell you  the exact day the plasmid(s) will ship, so please check in with the PlasmID  system for updates. <br><br> 
        ...
        A. Please see current pricing on <a href="OrderOverview.jsp">this page</a>.</span></p>
           <strong>Q. How much does shipping cost?</strong> <br>
...
A. Yes, the PSI-MR ships plasmids all over the world. See this <a href="http://www.batchgeocode.com/map/?i=bb69e015b8bfb20e06150bb05f4c95e3" target="_blank">map</a> to explore the locations where we have shipped plasmids over the past 3 years. If your country is not on the list of countries that we ship to, please <a href="mailto:plasmidhelp@hms.harvard.edu">contact us</a> so we can add it to our list.
 ...
 <br />
        ...
        <p><span class="mainbodytext"><strong>Q.&nbsp; Will I need to  get a signature on an MTA?</strong> <br>
          A. For certain plasmids, yes you will need  an MTA signature. We will be sure to identify the correct MTA and send it to you electronically to be signed by the appropriate official in your technology transfer office.&nbsp; An original signed copy of the MTA should be  returned to Catherine Cormier at Harvard Institute of Proteomics, 240 Longwood Ave, LHRRB, Boston, MA 02115.&nbsp; We will ship your plasmids  within 2 days of receipt of the signed MTA.</span></p>
...
COMPANIES: Most of the HIP  FLEXGene clones are available to companies and will be covered by a minimally  restrictive MTA between HIP and your company. We will email the MTA after you  place a request. You are also welcome to get in touch to review the terms  before placing your request.<br> 
        ...
        <p><strong class="homepageText2"><a name="deposit"></a>HOW TO DEPOSIT PLASMIDS</strong><br><br> 
         ...
         <a href="http://psimr.asu.edu/Depositor%20Agreement/DA.html">Click here</a> to learn more about  the Depositors Agreement.<br><br> 
          ...
          <br> 
          3. Plasmids that are hazardous  or legally restricted for distribution cannot be added to the repository. <br><br> 
          4. Plasmids that you do not  have the right to distribute (for example, plasmids you received from another  researcher and/or made by another person and/or protected by a patent,  licensing agreement, etc.) cannot be shared with us unless permission is also  granted by any and all relevant third parties. Sometimes this extends even to  modified forms of a plasmid.&nbsp; In general, you can share plasmids that you  made or made significant modifications, but you cannot share unmodified forms  of something you got from another researcher or a company.<br><br> 
          <strong>Q. How are plasmids  stored and handled after I share them?</strong> <br> 
        A. When you share plasmids with  the repository, we transform them into a phage-resistant bacterial host strain,  single colony isolate, and create working and archival glycerol stocks. These  are stored in conventional -80 degree freezers (archival copies) or in the  fully automated BioBank freezer storage system, in which working samples are  stored in individually 2D barcode-labeled tubes for automated retrieval and  array in any format.&nbsp; Information about each clone is carefully curated by PhD-level  scientists and entered into the database.</span></p> 
        <p><strong class="homepageText2"><a name="plasmidinfo"></a>INFORMATION  ABOUT OUR PLASMIDS</strong><br> 
          <br> 
          <strong>Q.  What's &quot;closed&quot; vs. &quot;fusion&quot; format?</strong> <br> 
...
<br> 
<strong>Q.  Can I use restriction enzymes with human clones in pDNR-Dual?</strong> <br> 
...
<br> 
<strong>Q.  What is the difference between a &quot;discrepancy&quot; and a  &quot;mutation&quot;? </strong> <br> 
...
<br> 
<strong>Q.  What's with recombinational cloning (pDNR-Dual, pDONR201, pDONR221, etc. vectors)?</strong> <br> 
...
<br> 
<strong>Q.  Do HIP cDNA/ORF clones have 5' or 3' UTRs?</strong> <br> 
...
<br> 
<strong>Q.  Can I get help identifying a large sub-group of clones bioinformatically?</strong> <br> 
...
<strong>A. </strong>The people who put in the hard work to  make the clone and any appropriate references should be cited! You should be  able to find this information on the clone detail page (click on the CloneID to  get there). Look for clone authors and PubMed IDs (vectors can also have  associated authors and PubMed IDs).</p> 
       ...
       Click here</a> for more detailed information about the PSI.<br> 
        ...
        <p><strong>Q.  How many PSI plasmids are available?</strong><br> 
          ...
          <br> 
          <strong>Q.&nbsp; I was part of PSI-1, do I also deposit my  plasmids with you?</strong><br> 
          Yes.&nbsp; Please <a href="Contactus.jsp">contact us</a> if you are a PSI-1 site so we can start the process with you.<br> 
          <br> 
          <strong>Q.&nbsp; Can I also deposit non-PSI clones with the  PSI-MR?&nbsp;&nbsp; </strong><br> 
      Absolutely!&nbsp;  Please <a href="Contactus.jsp">contact us</a> to discuss the details.</p></td> 
    </tr> 
  </table> 
