        ...
        <table width="100%" height="406" border="0" align="center" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
            <tr> 
                ...
                <td width="100%" align="left" valign="top">
                    ...
                    <p>
                    <html:form action="ViewSelectedInvoices.do">
                        <table width="100%" border="0">
                            ...
                            <logic:iterate id="invoice" name="<%=Constants.INVOICES%>"> 
                                <tr>
                                    ...
                                    <td class="tableinfo"><a href="ViewInvoiceDetail.do?invoiceid=<bean:write name="invoice" property="invoiceid"/>&orderid=<bean:write name="invoice" property="orderid"/>&isdownload=0"><bean:write name="invoice" property="invoicenum"/></a></td>
