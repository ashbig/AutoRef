                            ...
                            <table width="100%" border="0">
                                <logic:iterate name="cloneorder" property="clones" id="clone">
                                    ...
                                    <tr align="top,top">
                                        ...
                                        <td><pre><html:textarea rows="5" cols="80" name="cloneValidationForm" property='<%="sequence[" + i + "]"%>'/></pre></td>
                                    </tr>
                                    <tr>
                                        <td width="20">&nbsp;</td>
                                    ...
                                    <tr align="top,top">
                                        ...
                                        <td><pre><html:textarea rows="5" cols="80" name="cloneValidationForm" property='<%="read[" + i + "]"%>'/></pre></td>
                                    </tr>
                                    <tr>
                                        <td width="20">&nbsp;</td>
