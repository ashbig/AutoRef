...
<em>Last Updated: May 16, 2008</em></pre>
      <ul>
        <li class="mainbodytext"><a href="Submission checklist nonPSI v3.doc">Submission Checklist</a>.  This document will guide you through the submission process.  The items in this checklist highlight a variety of problems we have frequently encountered. </li>
        <li class="mainbodytext"><a href="Clone_files_table details_v1.doc">clone_files_table details</a>.  This document outlines the information we need regarding your plasmids. It also describes in detail the data format that is compatible with the parsing software that transfers this information into our sequencing and database programs.    If there are elements here that do not work for you, please contact me for further discussion.</li>
        <li class="mainbodytext"><a href="../CloneSubmission/Definitions for annotating CDS sequences_v4.doc">Definitions for annotating CDS sequences.</a> This document describes how to identify the NTSeq, relevant CDS, and linker sequences to input into the data tables.  This document addresses the questions we have encountered from various sites about how to annotate their sequences.</li>
        <li class="mainbodytext"><a href="SubmissionTable.xls">Submission Table.</a> This is an Excel spreadsheet containing the columns listed in the &ldquo;clone_file_table details.&rdquo;  This can serve as a template for you data submission, and you can delete the columns that do not apply to you.</li>
        <li class="mainbodytext"><a href="../VectorSubmission/vector template.xls">Vector Template</a>.  This is an Excel spreadsheet containing columns to help you provide us with information about your vectors.</li>
      </ul>
    </td>
  </tr>
</table>
