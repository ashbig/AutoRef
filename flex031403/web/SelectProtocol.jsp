...
<table>
    ...
    <td><select name="protocol">
        <logic:iterate id="oneProtocol" name="protocol" scope="request">
            <option value="<bean:write name="oneProtocol" property="key"/>"><bean:write name="oneProtocol" property="value"/>
        </logic:iterate>
    </td>
