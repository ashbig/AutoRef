 /*
    ...
    public class AAMutation extends Mutation
    {
        ...
        public AAMutation(int id) throws FlexDatabaseException
        {
            super(id);
        }
        
         public AAMutation(int num,int fl,int pos, int ln,String obj, String subj, 
         int hit, int seq, int id,int type, int hittype)
        {
            super( num,fl, pos,  ln, obj,  subj,  hit,  seq,  id, AA,hittype);
            if (type ==-1) 
        ...
        private int setType()
        {
            ...
            else if(o != null && m != null && o.substring( 0, 1).equals("*") )
            {
                if (m != null && !o.substring( 0, 1).equals(o.substring( 0, 1)))
                {
            ...
            else if(o != null && m!=null &&   o.equals(m))
            {
                ...
                (o != null && m != null &&  o.length() > m.length() && !m.substring( 0, 1).equals("*")))
            {
                ...
                && m.length()  == 1 )
            {
                ...
                similarity_score = edu.harvard.med.hip.flex.seqprocess.util.Constants.getScore(o.charAt(0),m.charAt(0));
