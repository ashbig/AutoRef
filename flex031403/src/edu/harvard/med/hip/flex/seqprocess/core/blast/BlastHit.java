...
//-The length of the match
    ...
    public BlastHit( int  hit_seqid,
                        int  score ,  double  identity ,
                        String  expect ,  double  pvalue ,
                        ...
                        int  subject_length , int ps, int bl,String q, String s,int gaps)
    {
    ...
    public BlastHit(int id) throws FlexDatabaseException
    {
        m_id = id;
    ...
    /*
    private ArrayList   getAllMutations() throws FlexDatabaseException
    {
