...
public class CreateCultureBlockForm extends ProjectWorkflowForm {
    ...
    public ActionErrors validate(ActionMapping mapping,
        ...
        if((agarPlateF2 == null) || (agarPlateF2.trim().length()!=11) || (agarPlateF2.charAt(LASTINDEX) != 'F')) {
            errors.add("agarPlateF2", new ActionError("error.plate.invalid.barcode", agarPlateF2));
            isReturn = true;
        }
        if((agarPlateC2 == null) || (agarPlateC2.trim().length()!=11) || (agarPlateC2.charAt(LASTINDEX) != 'C')) {
        ...
        if(!(agarPlateF2.substring(0, 3).equals(agarPlateC2.substring(0, 3)))) {
            errors.add("agarPlateF2", new ActionError("error.plate.mismatch", agarPlateF2, agarPlateC2));
        }
        if(agarPlateF1.substring(1, 3).equals("AA") && !(agarPlateF2.substring(1, 3).equals("AB"))) {
            errors.add("agarPlateF1", new ActionError("error.plate.mismatch", agarPlateF1, agarPlateF2));
        }       
        if(agarPlateC1.substring(1, 3).equals("AA") && !(agarPlateC2.substring(1, 3).equals("AB"))) {
            errors.add("agarPlateF1", new ActionError("error.plate.mismatch", agarPlateC1, agarPlateC2));
        }

        if(!(agarPlateF1.substring(1, 3).equals("AA")) &&
           !(agarPlateF1.substring(1, 3).equals("AC")) && 
           !(agarPlateF1.substring(1, 3).equals("AE")) &&
           !(agarPlateF1.substring(1, 3).equals("AG")) &&
           !(agarPlateF1.substring(1, 3).equals("AI")) &&
           !(agarPlateF1.substring(1, 3).equals("AK")) && 
           !(agarPlateF1.substring(1, 3).equals("AM")) &&
           !(agarPlateF1.substring(1, 3).equals("AO"))) {
           errors.add("agarPlateF1", new ActionError("error.plate.invalid.barcode", agarPlateF1));
        }
        ...
        if((agarPlateF1.substring(1, 3).equals("AC")) && !(agarPlateF2.substring(1, 3).equals("AD"))) {
            errors.add("agarPlateF1", new ActionError("error.plate.mismatch", agarPlateF1, agarPlateF2));
        }
        if((agarPlateF1.substring(1, 3).equals("AE")) && !(agarPlateF2.substring(1, 3).equals("AF"))) {
            errors.add("agarPlateF1", new ActionError("error.plate.mismatch", agarPlateF1, agarPlateF2));
        }
        if((agarPlateF1.substring(1, 3).equals("AG")) && !(agarPlateF2.substring(1, 3).equals("AH"))) {
            errors.add("agarPlateF1", new ActionError("error.plate.mismatch", agarPlateF1, agarPlateF2));
        }
        if((agarPlateF1.substring(1, 3).equals("AI")) && !(agarPlateF2.substring(1, 3).equals("AJ"))) {
            errors.add("agarPlateF1", new ActionError("error.plate.mismatch", agarPlateF1, agarPlateF2));
        }
        if((agarPlateF1.substring(1, 3).equals("AK")) && !(agarPlateF2.substring(1, 3).equals("AL"))) {
            errors.add("agarPlateF1", new ActionError("error.plate.mismatch", agarPlateF1, agarPlateF2));
        }
        if((agarPlateF1.substring(1, 3).equals("AM")) && !(agarPlateF2.substring(1, 3).equals("AN"))) {
            errors.add("agarPlateF1", new ActionError("error.plate.mismatch", agarPlateF1, agarPlateF2));
        }
        if((agarPlateF1.substring(1, 3).equals("AO")) && !(agarPlateF2.substring(1, 3).equals("AP"))) {
            errors.add("agarPlateF1", new ActionError("error.plate.mismatch", agarPlateF1, agarPlateF2));
        }
