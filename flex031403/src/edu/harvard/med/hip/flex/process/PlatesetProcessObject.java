 ...
 * @version 
 */
public class PlatesetProcessObject extends ProcessObject {
    /**
     * Constructor.
     *
    ...
    public void insert(Connection conn)throws FlexDatabaseException {
        String sql = "insert into processobject "+
                     "(executionid, inputoutputflag, platesetid) "+
    ...
    public static void main(String[] args) {
        PlatesetProcessObject seqobject = new PlatesetProcessObject(1, 28, "I");
        Connection c = null;
