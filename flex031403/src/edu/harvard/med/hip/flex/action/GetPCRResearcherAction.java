...
public class GetPCRResearcherAction extends ResearcherAction {
    ...
    throws ServletException, IOException {
        ...
        String cdnaLibrary = (String)request.getSession().getAttribute("EnterOligoPlateAction.cdnaLibrary");
        ...
        try {
            ...
            System.out.println("Printing barcode: "+pcrClosedContainer.getLabel());
