 ...
 * @author DZuo
 */
public class MicrovigeneslideTO {
    private int slideid;
    private String date;
    ...
    public MicrovigeneslideTO() {
        setSpots(new ArrayList<MicrovigeneresultTO>());
    }

    public MicrovigeneslideTO(String version, String date, int roirow, int roicol, int mainrow, int maincol, int subrow, int subcol) {
        setVersion(version);
        setDate(date);
    ...
    public int calculatePosition(int spotmainrow, int spotmaincol, int spotsubrow, int spotsubcol) {
        //System.out.println(spotmainrow+","+spotmaincol+","+spotsubrow+","+spotsubcol);
