...
<html:errors/>
<p>
<html:form action="/EnterSrcForGlycerolAndSeqOneRow.do" focus="plate1">
...
<table>
 <tr>
    ...
    <tr>
    <td class="prompt">Enter 5th culture plate barcode:</td>
    <td><html:text property="plate5" size="40"/></td>
    </tr>

    <tr>
    <td class="prompt">Enter 6th culture plate barcode:</td>
    <td><html:text property="plate6" size="40"/></td>
    </tr>

    <tr>
    <td class="prompt">Enter 7th culture plate barcode:</td>
    <td><html:text property="plate7" size="40"/></td>
    </tr>
