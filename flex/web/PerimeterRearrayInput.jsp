...
<table>
    <tr>
    <td class="prompt">Enter the label for media container:</td>
    <td><html:text property="mediaPlate" value="Media"/></td>
    </tr>

    <tr>
    <td class="prompt">Select the type for media container:</td>
    <td><html:select property="mediaPlateType">
    ...
    <tr>
    <td class="prompt">Enter the media volumn that you want to dispense (in microliter):</td>
    <td><html:text property="mediaVolumn" value="25"/></td>
    </tr>

    <tr>
    <td class="prompt">Enter the media volumn that you want to aspirate (in microliter):</td>
    <td><html:text property="maxMediaVolumn" value="150"/></td>
    </tr>
</table>
...
<table>
    ...
    <td><html:text property="mixPlate" value="Mix"/></td>
    </tr>
    ...
    <tr>
    <td class="prompt">Enter the transfection mix volumn that you want to aspirate (in microliter):</td>
    <td><html:text property="maxMixVolumn" value="150"/></td>
    </tr>
</table>
