...
public class OligoPlater
{
    ...
    private LinkedList oligoPatternList = null;
    private LinkedList constructList = null;
    private Plateset plateset;
    private Connection conn = null;
    private Container container_5p = null;
    private Container container_3s = null;
    private Container container_3op = null;
    ...
    private boolean     m_isNotPseudomonas = false;
    ...
    throws FlexDatabaseException, IOException
    {
        ...
        m_negativeControlPosition = m_totalWells + 2;
         m_negativeControlPosition = 2+ totalWells ;
    ...
    protected void generateOligoOrder() throws FlexDatabaseException, IOException
    {
       ...
       for (int geneCount = 0 ; geneCount < orderedOligos.size(); geneCount++)
       {
           ...
           {
                updateOligoPlates();
                plateWriter_5p.flush();          plateWriter_5p.close();

                if( m_isNotPseudomonas )
                {
                    plateWriter_3s.flush();                    plateWriter_3s.close();
                }

                plateWriter_3op.flush();                plateWriter_3op.close();
            }
     ...
     */
    private void outputGene(OligoPattern currentGene, int well)throws FlexDatabaseException, IOException
    {
     ...
     */
    private void prepareFilesForOligoOrder() throws FlexDatabaseException, IOException
    {
     ...
     */
    private void generateControlSamples(int negativeControl)throws FlexDatabaseException
    {
