...
public class PolymorphismSpec extends Spec
{
    ...
    public PolymorphismSpec(Hashtable p, String na, String submitter)
    {
         super( p,  na, submitter, Spec.POLYMORPHISM_SPEC_INT);
         cleanup_parameters();
    }
    
     public PolymorphismSpec(Hashtable p, String na, String submitter, int id) 
    {
         super( p,  na, submitter, POLYMORPHISM_SPEC_INT,id);
         cleanup_parameters();
    }
     ...
     {
         return getAllSpecsByTypeAndSubmitter(Spec.POLYMORPHISM_SPEC_INT, submitter);
     }
