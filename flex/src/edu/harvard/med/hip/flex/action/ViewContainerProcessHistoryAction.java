 ...
 *
 * @author     $Author: dz4 $
 * @version    $Revision: 1.12 $ $Date: 2008-04-14 20:34:05 $
 */
    ...
    public ActionForward flexPerform(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            if (containerIdS != null && containerIdS.length() != 0) {
                ...
                List containerList = Container.findContainersForLabel(containerBarcode, false, false);
