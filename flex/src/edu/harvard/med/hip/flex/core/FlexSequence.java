...
throws FlexDatabaseException
{
    ...
    while(enum.hasMoreElements())
    {
        ...
        {
            String desc =
            DatabaseTransaction.prepareString((String)h.get(DESCRIPTION));
                            ...
                            throws FlexDatabaseException
{
        ...
        String sql = "insert into name (sequenceid, nametype, namevalue";
        String appSql = "values("+id+",'"+typename+"','"+typevalue+"'";
        
        if( nameurl != null && !nameurl.equals(""))
        {
            sql = sql+",nameurl";
            appSql = appSql+",'"+nameurl+"'";
        }
        
        if( namedesc != null && !namedesc.equals(""))
        {
            String desc = DatabaseTransaction.prepareString(namedesc);
