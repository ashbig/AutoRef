...
public class Location {
     ...
     */
    public Location(String locationName) throws FlexDatabaseException, FlexCoreException {
        ...
        try{
            if(rs.next()) {
                ...
                throw new FlexCoreException("Cannot find Location with type: "+locationName);
            }
